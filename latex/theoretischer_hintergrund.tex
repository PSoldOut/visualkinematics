...
Diese Transformation setzt sich aus einer Translation (Verschiebung) und einer Rotation (Drehung) zusammen \cite[24-27]{Robotics_Vision_and_Control}.
...
Damit lässt sich die Pose als ein Vektor aus diesen drei Elementen darstellen \cite[59]{autonomous_mobile_robots}.
...
wobei keine zwei aufeinanderfolgenden Rotationen um die gleiche Achse erfolgen dürfen \cite[136]{Quaternions_and_Rotation_Sequences_A_Primer_with_Applications_to_Orbits_Aerospace_and_Virtual_Reality}.
...
Ebenso ist die Inverse jeder Rotationsmatrix ebenfalls Teil der Gruppe \cite[33]{Robotics_Vision_and_Control}.
...
bezeichnet.\\
 ...
 was sie besonders attraktiv für Anwendungen in Bereichen wie Robotik, Computer Vision, Computergrafik und Navigation macht \cite[59-61]{Robotics_Vision_and_Control}.
...
JupyterLab ist eng verwandt mit anderen Anwendungen unter dem Dach von Project Jupyter, wie zum Beispiel Jupyter Notebook und Jupyter Desktop. Im Vergleich zu Jupyter Notebook bietet JupyterLab jedoch eine fortschrittlichere, funktionsreichere und individuell anpassbare Benutzererfahrung \cite{jupyterlab_docs}.