...
Im folgenden Abschnitt werden die verschiedenen Technologien die für die erstellung des Frameworks verwendet worden sind
...
Abschließend werden die Beispiel-Notebooks sowie deren Funktionen und Einsatzmöglichkeiten erklärt.
...
die Umwandlung von Quaternionen in Rotationsmatrizen oder deren Umkehrung.
...
den der Roboter abfahren soll. Zum erstellen den Pfads wird ein Dummy objekt benötigt um die Bewegung des Roboters für die Pfadgenerierung zu simulieren (siehe Anhang).
...
Anschließend wird die move() Funktion für jeden Abschnitt der Bahn aufgerufen. Dabei werden in diesem Beispielnotebook bereits
...
Um diese Ausgabe zu erreichen wurde ein Würfel sowie ein Environment-Objekt erzeugt. der Würfel wurden zu dem Environment-Objekt
hinzugefügt und anschließend wurden mit der Funktion add\_gizmo\_controls() (siehe Anhang) Schieberegler zur Transformation des Würfels zum Environment-Objekt
...
\begin{quote}
    ...
    \vspace{1em}
        ...
        \begin{figure}[H]
            ...
            \caption{Quader aus Klausuraufgabe}
...
\vspace{1em}
Mit der Funktion rotate\_global\_animated(mesh, angles, order) (siehe Anhang) wird der Quader zunächst wie in der Aufgabe beschrieben
...
Danach wird mit der Funktion rotate\_animated(mesh, angles, order) (siehe Anhang) der Quader um sein körpereigenes Koordinatensystem rotiert, wobei jedoch die Rotationsreihenfolge invertiert wird.
...
Anschließend werden die Matrizen als Variablen aufgestellt, zusammengefasst und an die Funktion apply\_rot\_matrix\_animated(mesh, rot\_mat, speed, show\_rot\_mat) (siehe Anhang) übergeben, sodass
die Rotation des Quaders anhand der Rotationsmatrix betrachtet und mit der vorangegangenen Transformation vergleichen werden kann.
