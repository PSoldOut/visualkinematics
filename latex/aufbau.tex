...
Danach wird mit der Funktion rotate\_animated(mesh, angles, order) der Quader um sein körpereigenes Koordinatensystem rotiert, wobei jedoch die Rotationsreihenfolge invertiert wird.
...
die Rotation des Quaders anhand der Rotationsmatrix betrachtet und mit der vorangegangenen Transformation vergleichen werden kann. Dieses Notebook kann vom Aufgabensteller so modifiziert werden,
