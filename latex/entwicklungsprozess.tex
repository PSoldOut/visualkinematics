...
Anschließend wurde zuerst ein Prototyp auf Basis von Three.js erstellt und anschließend ein zweiter auf Basis von Pythreejs um die Eignung dieser Tools 
...
da moderne Webanwendungen typischerweise ohne lokale Installation auskommen wollen \doublecite{opengl_doc}.
...
Der Prototyp umfasst zunächst eine virtuelle Kamera, eine ambiente Lichtquelle sowie einen Würfel, die alle zu einer Szene hinzugefügt werden.
...
Der würfel wird pro Animationsframe ein kleines bischen um die x- und y-Achse des körpereigenen Koordinatensystems rotiert.
Dies stellt die grundlegenden Funktion des Prototyps dar: die interaktive Steuerung sowie Animation eines 3D-Objekts.
...
Da der Prototyp verschiedene \textit{numerische}\footnote{Im mathematischen Sinn bedeutet numerisch, dass ein Problem mit Hilfe von Zahlenwerten und Näherungsverfahren gelöst wird,
...
Sekunden, während SymPy für dieselbe Operation rund 9.7 Sekunden benötigte.
\begin{center}
    \begin{verbatim}
...
sodass auch bei Verwendung von SymPy eine korrekte und performante Ausführung gewährleistet bleibt. Die Vorraussetzung
dafür ist jedoch dass die übergebenen sympy.Matrix-Objekte sich auf konkrete Werte oder Annäherungen zurückführen lassen.
