...
Ein weiterer Nachteil von Babylon.js ist, dass es auch ein eigenen Browser-Tab benötigt,
...
Abbildung \ref{fig:Verteilungsdiagramm-Prototyp} zeigt die Softwareumgebung und Einbettung des Prototypen in form eines Verteilungsdiagramms.
\vspace{1em}
...
Abbildung \ref{fig:Prototyp2} zeigt den Visuellen Output des Renderers innerhalb des Prototypen,
wobei es sich bei dem Prototypen um ein Jupyter-Notebook handelt.
\vspace{1em}
...
Zum Ende der Programmierarbeit hin wurde klar, welche gemeinsamkeiten die Szenarien in rotation.ipynb, quader.ipynb und robot.ipynb und womöglich auch zukünftige Aufgabentypen haben.
