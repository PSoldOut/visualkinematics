...
Im Rahmen dieser Projektarbeit wird ein \textit{Framework}\footnote{Ein Framework ist ein vorgefertigtes Gerüst aus Softwarekomponenten, das bei der Entwicklung von Anwendungen hilft,
indem es wiederverwendbare Strukturen und Funktionen bereitstellt.
Es legt meist einen Rahmen für die Programmstruktur und den Ablauf fest, innerhalb dessen eigene Komponenten integriert werden können.} entwickelt, das die Visualisierung kinematischer Kennwerte ermöglicht.
