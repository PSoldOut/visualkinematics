...
Bei genauer Betrachtung lässt sich sagen, dass die meisten dieser Anforderungen erfüllt wurden.
...
Die Kompatibilität mit SymPy wurde ebenfalls sichergestellt. Die Funktionen in Util.py können problemlos Matrixobjekte der Sympy Bibliothek entgegennehmen,
...
Einziger Aspekt, der im aktuellen Projekt\-status noch nicht voll\-stän\-dig um\-ge\-setzt wurde,
