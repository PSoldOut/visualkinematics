...
den der Roboter abfahren soll. Zum Erstellen des Pfads wird ein Dummy-Objekt benötigt, welches die Bewegung des Roboters für die Pfadgenerierung simuliert (siehe Anhang).
