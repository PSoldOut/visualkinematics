...
\subsubsection*{\colorbox{lightgray}{\texttt{\textbf{\color{green} def} \color{blue} createQuad}\textbf{\texttt{(pos, width, height, depth, color=[0, 255, 0], transparent=True):}}}}
...
\subsubsection*{\colorbox{lightgray}{\texttt{\textbf{\color{green} def} \color{blue} move\_robot}\textbf{\texttt{(robot, vel, steps=1):}}}}
...
\begin{itemize}
    ...
    \item \texttt{grid}: Ein Gitterobjekt, das in der Szene angezeigt wird (Standard: \texttt{create\_grid\_XY(14, 0.5)}).
